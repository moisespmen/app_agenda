...
class RedefinirSenhaNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line(Lang::get('Este link de redefinição de senha expira em '.$minutos. ' minutos'))
            ->line(Lang::get('Se você não solicitou a redefinição de senha, nenhuma outra ação será necessária.'))
